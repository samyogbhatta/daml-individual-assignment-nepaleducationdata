...
1. Clone the repository:
   ```bash
   git clone https://github.com/samyogbhatta/daml-individual-assignment-nepaleducationdata.git
   ```
...
## Contributing
Contributions are welcome! Please fork the repository and create a pull request for any changes. Ensure your code follows the repository's coding standards.
